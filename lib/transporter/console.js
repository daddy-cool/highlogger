...
class Console extends AbstractTransporter {
  ...
  write (message, options, callback) {
    ...
    if (this.colors) {
      ...
      if (debug) {
        if (this.debugKeys[options.debugKey]) {
          options.debugKey = this.chalk[this.debugKeys[options.debugKey]](options.debugKey);
        } else {
          let color = textColors[this.textColorIndex];

          this.debugKeys[options.debugKey] = color;
          options.debugKey = this.chalk[color](options.debugKey);
