...
class Transporters {
  ...
  initTransporterTypes () {
    let transporterFilesKeys = Object.keys(transporterFiles),
        transporterFilesKeysLength = transporterFilesKeys.length,
        transporterFilesKeysIterator = 0;

    while (transporterFilesKeysIterator < transporterFilesKeysLength) {
  ...
  initTransporters () {
    let configKeys = Object.keys(this.config),
        ...
        configKeysIterator = 0;

    while (configKeysIterator < configKeysLength) {
