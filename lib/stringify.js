...
const JSON_CONVERT_TIMEOUT_MSG = CircularJSON.stringify({msg: 'stringify timeout after ' + JSON_CONVERT_TIMEOUT + 'ms'});
const JSON_MAX_LENGTH_ZERO = CircularJSON.stringify({msg: ''});
