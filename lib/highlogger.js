...
function populateConfig (config) {
  ...
  if (typeof config.debugKeys !== SHARED_CONSTANTS.OBJECT_TYPE.OBJECT) {
    ...
    if (typeof config.debugKeys.include !== SHARED_CONSTANTS.OBJECT_TYPE.OBJECT || !(config.debugKeys.include instanceof Array)) {
      config.debugKeys.include = CONFIG_DEFAULT.debugKeys.include;
    }
    if (typeof config.debugKeys.exclude !== SHARED_CONSTANTS.OBJECT_TYPE.OBJECT || !(config.debugKeys.exclude instanceof Array)) {
